        ...
        <div class="col-lg-6 col-xl-6 col-md-12 col-sm-12 m-auto">
            <div class="card  box-shadow-0">
                <div class="card-header">
                    <h4 class="card-title mb-1">Update Attribute</h4>
                    <p class="mb-2">you can now update category attribute</p>
                </div>
                @if ($errors->any())
                ...
                <div class="card-body pt-0">
                    <form class="form-horizontal" action="{{ route('attributes.update', ['attribute' => $attribute->id]) }}"
                        method="POST">
                        @csrf
                        @method('put')
