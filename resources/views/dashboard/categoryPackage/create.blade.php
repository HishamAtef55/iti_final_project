...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">Category's packages</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Add Categories </span>
						</div>
					</div>
					...
					<div class="col-lg-12 col-md-12">
						<div class="card">
							<div class="card-body">
								...
								<div class="row">
									<div class="col-lg-12">
										<form action="{{route('package_category.store')}}" method="POST" class="bg-gray-200 p-4">
											@csrf
