            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="breadcrumb-wrapper">
                        <h2 class="product-title">Add User</h2>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-5 col-md-12 col-xs-12">
                    <div class="register-form login-area">
                        ...
                        <form class="login-form" method="POST" action="{{ route('registerr') }}">
                            @csrf
                                ...
                                {{-- ************************** --}} <div class="form-group">
                                    <div class="input-icon">
                                        <input id="address" type="text"
                                            ...
                                            placeholder="Address" name="address" required autocomplete="address" autofocus
                                            pattern="^[a-zA-Z ]{3,}$" title="address should be more than 3 characters">
