...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					...
					<div class="d-flex my-xl-auto right-content">
						<a class="btn btn-primary btn-block" href="{{ route('package_category.create',$package->id) }}">Add User</a>
					</div>
				</div>
				<!-- breadcrumb -->
@endsection
						...
						<div class="card">
							<div class="card-header pb-0">
								<div class="d-flex justify-content-between">
									<h4 class="card-title mg-b-0">All Buyers of {{$package->name}} </h4>
								</div>
							</div>
							<div class="card-body">
									...
									<table class="table text-md-nowrap" id="example1">
										<thead>
											<tr>
												...
												<th class="wd-auto text-center border-bottom-0"> User Name </th>
												<th class="wd-auto text-center border-bottom-0"> Category Name </th>
										...
										<tbody>
											...
											<tr>
                                                ...
                                                <td class="text-center"> 
													<a class="btn btn-primary " href="{{ route('user.packages',$user->pivot->user_id) }}">Show</a>
												</td>
											</tr>
											@endforeach
										</tbody>
